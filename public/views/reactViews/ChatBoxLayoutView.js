...
var ChatBoxLayoutView = React.createClass({
	...
	render:function(){	
		return(
			<li className="row" ref={this.props.data.toUserId}>
				<div className={this.props.data.toUserId} id="chatBox">
					<div className="chat-header col-lg-12 col-md-12 col-sm-12">
						<div className="row">
							<div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 title-sec">
								<img src="../../images/emoji/12.gif" title={self.props.data.title}/>
								<div className="user-name">{self.props.data.title}</div>
								<div className="row minimize-icon-sec hide">
									<div className="glyphicon glyphicon-plus col-lg-3 col-md-3 col-sm-3 col-xs-3 plus-icon" onClick={this.handleMaximize} data-attr-user={self.props.data.toUserId}>
									</div>
									<div className="glyphicon glyphicon-remove col-lg-3 col-md-3 col-sm-3 col-xs-3" onClick={this.handleCloseIcon} data-attr-user={self.props.data.toUserId}>
									</div>
								</div>
							</div>
							<div className="col-lg-3 col-md-6 col-cs-6 col-sm-6 col-lg-offset-3 icon-sec">
								<div className="row">
									<div className="glyphicon glyphicon-minus col-lg-3 col-sm-3 col-md-3 col-xs-3" onClick={this.handleMiniMizeClick} data-attr-user={self.props.data.toUserId}>
									</div>
									<div className="glyphicon glyphicon-remove col-lg-3 col-sm-3 col-md-3 col-xs-3" onClick={this.handleCloseIcon} data-attr-user={self.props.data.toUserId}>
									</div>
								</div>
							</div>
						</div>
					</div>
					<div className="chat-body col-lg-12 col-md-12 col-sm-12 padding-none">
						<ul className="msg-list-sec padding-none">
						</ul>
					</div>
					<div className="msg-send-sec col-lg-12 col-md-12 col-sm-12">
						<div className="row">
							<div className="colg-lg-12 col-md-12 col-sm-12 padding-none">
								<div className="col-lg-6 col-md-6 col-sm-6">
									<div className="row form-group">
										<input type="text" className="msg-text form-control" id="messageBox" onKeyDown={this.sendMessage}/>
									</div>
								</div>
								<div className="col-lg-6 col-md-6 col-sm-6">
									<div className="row">
										<div className="col-lg-1 col-md-6 col-sm-12 col-lg-offset-1 col-md-offset-1">
											<input type="button" className="btn btn-success" value="&#8594;" id="sendBtn" onClick={this.sendMessage}
											/>
										</div>
										<div className="col-lg-1 col-md-1 col-sm-12 col-lg-offset-2 col-md-offset-1">
											<input type="button" className="btn btn-danger" value="+" id="addImage"
							...
							<div className="emoji-sec row">
								<div className="emoji-panel col-lg-12">
									<ul className="emoji-list hide">
										<PanelView data={self.props.data} parent={self} userName={self.state.userName}/>
									</ul>
								</div>								
							</div>
						</div>
