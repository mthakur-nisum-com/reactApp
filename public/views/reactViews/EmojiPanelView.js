...
var EmojiPanelView = React.createClass({
	...
	addEmoji:function(e){
		/*self.props.parent.setState({emoji:$('.'+targetWindow).find('#messageBox').val($('.'+targetWindow).find('#messageBox').val() + '[emoji:' + e.target.title + ']')
		})*/
	...
	render:function(){
		...
		return (
			<ul className=" smily-list padding-none colg-lg-12" onClick={this.addEmoji}>
