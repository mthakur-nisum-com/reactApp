...
var ChatBoxLayoutView = React.createClass({displayName: "ChatBoxLayoutView",
	findOpenedWindow:function(windowArrayList,userName){
		windowArrayList.map(function(value,index){
			if(value.userWindow === userName) {
				value.isMaximized=false;
				console.log(value);
				return value.userWindow;
			}
		})
	},
	...
	handleMiniMizeClick:function(e) {
		console.log(chatBoxOpenList,e.currentTarget.getAttribute('data-attr-user'));
		console.log(self.findOpenedWindow(chatBoxOpenList,e.currentTarget.getAttribute('data-attr-user')));
