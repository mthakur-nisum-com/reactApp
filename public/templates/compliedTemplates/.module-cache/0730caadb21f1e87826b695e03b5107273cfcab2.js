					...
					React.createElement("div", {className: "chat-header col-lg-12 col-md-12 col-sm-12"}, 
						React.createElement("div", {className: "row"}, 
							React.createElement("div", {className: "col-lg-6 col-md-6 col-sm-6 col-xs-6"}, 
								React.createElement("img", {src: "../../images/emoji/12.gif", title: self.props.data.title, className: "banner-img"}), 
									React.createElement("div", null, self.props.data.title)
							), 
							React.createElement("div", {className: "col-lg-6 col-md-6 col-cs-6 col-sm-6"}, 
								React.createElement("div", {className: "row"}, 
									React.createElement("div", {className: "col-lg-3 col-sm-3 col-md-3 col-xs-3"}, 
										React.createElement("div", {className: "row glyphicon glyphicon-paperclip"})
									), 
									React.createElement("div", {className: "col-lg-3 col-sm-3 col-md-3 col-xs-3"}, 
										React.createElement("span", {class: "glyphicon glyphicon-remove", "aria-hidden": "true"}, "helo")
									)
								)
							)
						)
