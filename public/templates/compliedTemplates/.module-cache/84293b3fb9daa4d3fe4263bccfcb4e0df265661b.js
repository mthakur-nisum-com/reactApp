...
var PanelView =React.createClass({displayName: "PanelView",
	handleClick:function(e){
		...
		switch	(tabType) {
			case "file-tab":
			  self.setState({currentView:React.createElement(AttachmentView, {data: self.props.data, parent: self.props.parent})});
			  break;
			case "mail-tab":
			  self.setState({currentView:React.createElement(MailView, {userName: self.props.userName})});
			  break;
			default:
			  self.setState({currentView:React.createElement(EmojiPanelView, {data: self.props.data, parent: self.props.parent})});
			  break;
		}
	},
