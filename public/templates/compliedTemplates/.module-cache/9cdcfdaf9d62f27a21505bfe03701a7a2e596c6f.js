...
var ChatBoxLayoutView = React.createClass({displayName: "ChatBoxLayoutView",
	...
	handleMiniMizeClick:function(e) {
		$('.'+self.props.data.toUserId).addClass("minimize-class");
		$('.'+self.props.data.toUserId).addClass("minimized-header");
		$('.'+self.props.data.toUserId).find('.minimize-icon-sec').removeClass("hide");
		$('.'+self.props.data.toUserId).find('.msg-send-sec').addClass("hide");
		$('.'+self.props.data.toUserId).find('.chat-body').addClass("hide");
		$('.'+self.props.data.toUserId).find('.icon-sec').addClass("hide");
		$('.'+self.props.data.toUserId).find('.title-sec').addClass('padding-none');
	...
	handleMaximize:function(e){
		$('.'+self.props.data.toUserId).removeClass("minimize-class");
		$('.'+self.props.data.toUserId).removeClass("minimized-header");
		$('.'+self.props.data.toUserId).find('.minimize-icon-sec').addClass("hide");
		$('.'+self.props.data.toUserId).find('.msg-send-sec').removeClass("hide");
		$('.'+self.props.data.toUserId).find('.chat-body').removeClass("hide");
		$('.'+self.props.data.toUserId).find('.icon-sec').removeClass("hide");
		$('.'+self.props.data.toUserId).find('.title-sec').removeClass('padding-none');
	},
						...
						React.createElement("div", {className: "row"}, 
							React.createElement("div", {className: "col-lg-6 col-md-6 col-sm-6 col-xs-6 title-sec"}, 
								...
								React.createElement("div", {className: "row minimize-icon-sec hide"}, 
									React.createElement("div", {className: "glyphicon glyphicon-plus col-lg-3 col-md-3 col-sm-3 col-xs-3 plus-icon", onClick: this.handleMaximize}
									), 
									React.createElement("div", {className: "glyphicon glyphicon-remove col-lg-3 col-md-3 col-sm-3 col-xs-3", onClick: this.handleCloseIcon}
									)
								)
							), 
