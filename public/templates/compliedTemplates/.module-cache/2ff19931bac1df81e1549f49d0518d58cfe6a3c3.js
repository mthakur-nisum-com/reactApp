...
var ChatBoxLayoutView = React.createClass({displayName: "ChatBoxLayoutView",
	...
	handleMiniMizeClick:function(e) {
		$('.'+self.props.data.toUserId).delay(200).addClass("minimize-class");
		$('.'+self.props.data.toUserId).find('.msg-send-sec').delay(200).addClass("minimized-header");
		$('.'+self.props.data.toUserId).find('.chat-body').delay(200).addClass("minimized-header");
	},
					...
					React.createElement("div", {className: "chat-header col-lg-12 col-md-12 col-sm-12"}, 
						React.createElement("div", {className: "row"}, 
							...
							React.createElement("div", {className: "col-lg-3 col-md-6 col-cs-6 col-sm-6 col-lg-offset-3 icon-sec"}, 
								React.createElement("div", {className: "row"}, 
									React.createElement("div", {className: "glyphicon glyphicon-minus col-lg-3 col-sm-3 col-md-3 col-xs-3"}
									), 
