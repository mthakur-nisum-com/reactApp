...
var ChatBoxLayoutView = React.createClass({displayName: "ChatBoxLayoutView",
	...
	handleMiniMizeClick:function(e) {
		$('.'+self.props.data.toUserId).delay(3000).addClass("minimize-class");
		$('.'+self.props.data.toUserId).find('.msg-send-sec').delay(3000).addClass("hide");
		$('.'+self.props.data.toUserId).find('.chat-header').delay(3000).addClass("minimized-header");
		$('.'+self.props.data.toUserId).find('.chat-body').delay(3000).addClass("hide");
		$('.'+self.props.data.toUserId).find('.icon-sec').delay(3000).addClass("hide");
