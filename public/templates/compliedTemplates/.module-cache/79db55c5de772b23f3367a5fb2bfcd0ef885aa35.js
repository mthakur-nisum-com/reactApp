...
var ChatBoxLayoutView = React.createClass({displayName: "ChatBoxLayoutView",
	...
	handleMiniMizeClick:function(e) {
		$('.'+self.props.data.toUserId).delay(6200).addClass("minimize-class");
		$('.'+self.props.data.toUserId).find('.msg-send-sec').delay(6200).addClass("hide");
		$('.'+self.props.data.toUserId).find('.chat-body').delay(6200).addClass("hide");
	},
