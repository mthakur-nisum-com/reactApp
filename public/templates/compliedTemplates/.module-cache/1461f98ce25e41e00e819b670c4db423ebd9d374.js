...
var ChatBoxLayoutView = React.createClass({displayName: "ChatBoxLayoutView",
	findOpenedWindow:function(windowArrayList,userName,eventType){
		for(var i in windowArrayList) {

			if(windowArrayList[i].userWindow === userName) {
				if(eventType === 'maximize') {
					windowArrayList[i].isMaximized=true;
				}
				return windowArrayList[i].userWindow;
			}
		}
	},
	swapWindows:function(targetElement,firstElement,parentContainer){
	...
	handleMiniMizeClick:function(e) {	
		self.findOpenedWindow(chatBoxOpenList,e.currentTarget.getAttribute('data-attr-user'),'minimize');
		$('.'+e.currentTarget.getAttribute('data-attr-user')).addClass("minimize-class");
		$('.'+e.currentTarget.getAttribute('data-attr-user')).addClass("minimized-header");
		$('.'+e.currentTarget.getAttribute('data-attr-user')).find('.minimize-icon-sec').removeClass("hide");
		$('.'+e.currentTarget.getAttribute('data-attr-user')).find('.msg-send-sec').addClass("hide");
		$('.'+e.currentTarget.getAttribute('data-attr-user')).find('.chat-body').addClass("hide");
		$('.'+e.currentTarget.getAttribute('data-attr-user')).find('.icon-sec').addClass("hide");
		$('.'+e.currentTarget.getAttribute('data-attr-user')).find('.title-sec').addClass('padding-none');
	...
	handleMaximize:function(e){
		self.findOpenedWindow(chatBoxOpenList,e.currentTarget.getAttribute('data-attr-user'),'maximize');
		$('.'+e.currentTarget.getAttribute('data-attr-user')).removeClass("minimize-class");
		$('.'+e.currentTarget.getAttribute('data-attr-user')).removeClass("minimized-header");
		$('.'+e.currentTarget.getAttribute('data-attr-user')).find('.minimize-icon-sec').addClass("hide");
		$('.'+e.currentTarget.getAttribute('data-attr-user')).find('.msg-send-sec').removeClass("hide");
		$('.'+e.currentTarget.getAttribute('data-attr-user')).find('.chat-body').removeClass("hide");
		$('.'+e.currentTarget.getAttribute('data-attr-user')).find('.icon-sec').removeClass("hide");
		$('.'+e.currentTarget.getAttribute('data-attr-user')).find('.title-sec').removeClass('padding-none');
	    self.swapWindows(this.refs[e.currentTarget.getAttribute('data-attr-user')],document.getElementById('chat-box-list').firstChild,'chat-box-list');
	},
