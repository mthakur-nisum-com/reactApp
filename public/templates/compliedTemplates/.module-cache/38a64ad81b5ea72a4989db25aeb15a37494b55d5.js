								...
								React.createElement("form", null, 
									React.createElement("div", {className: "row form-group"}, 
										...
										React.createElement("div", {className: "col-lg-6 col-md-8 col-sm-12 col-xs-12"}, 
											React.createElement("input", {type: "name", valueLink: this.linkState('callLink'), className: "col-lg-12 col-md-12 col-sm-12 col-xs-12 form-control", onKeyUp: this.findUser})
										)
									), 
									React.createElement("div", {className: "row form-group"}, 
