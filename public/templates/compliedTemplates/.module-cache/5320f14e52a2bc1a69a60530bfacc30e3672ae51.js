								...
								React.createElement("form", null, 
									React.createElement("div", {className: "row form-group"}, 
										...
										React.createElement("div", {className: "col-lg-6 col-md-8 col-sm-12 col-xs-12 usr-search-list"}, 
											...
											React.createElement("input", {type: "hidden", valueLink: this.linkState('targetUser'), id: "targetUser"}), 
											React.createElement("ul", {className: "col-lg-11 padding-none search-key-list", onClick: this.addUser}, 
