				...
				React.createElement("div", {className: this.props.data.toUserId, id: "chatBox"}, 
					React.createElement("div", {className: "chat-header col-lg-12 col-md-12 col-sm-12"}, 
						React.createElement("div", {className: "row"}, 
							...
							React.createElement("div", {className: "col-lg-3 col-md-6 col-cs-6 col-sm-6 col-lg-offset-3"}, 
								React.createElement("div", {className: "row"}, 
									React.createElement("div", {className: "glyphicon glyphicon-minus col-lg-3 col-sm-3 col-md-3 col-xs-3", onClick: this.handleCloseIcon}
									), 
									React.createElement("div", {className: "glyphicon glyphicon-remove col-lg-3 col-sm-3 col-md-3 col-xs-3"}
									)
								)
							)
						)
